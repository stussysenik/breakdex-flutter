...
Users SHALL be able to rate the affinity between two moves as natural, possible, or stretch (Pokemon-inspired).
...
A radial/graph view SHALL show the user's personal transition style fingerprint.
...
Users SHALL be able to save and switch between named aura configurations.
...
The Set Builder SHALL use the active Bboy Aura to suggest compatible next moves.
