// GENERATED preview entries for CombosScreen. Safe to edit — add @Preview variants
...
@Preview(name: 'CombosScreen · dark', group: 'combos', wrapper: wrapDark)
Widget combosScreenDark() => const CombosScreen();
